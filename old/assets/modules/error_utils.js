...
/**
* Displays an error message in the toast
...
/**
* Creates a toast element if it doesn't exist
* @param {string} message - Message to display
*/
const createToastElement = (message) => {
   const toast = document.createElement('div');
   toast.id = 'toast';
   toast.className = 'fixed bottom-20 right-5 px-4 py-2 rounded-md shadow-lg z-60';
...
/**
* Safe function to handle null elements
