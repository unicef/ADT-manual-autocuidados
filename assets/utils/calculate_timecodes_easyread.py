'''
HOW TO:
type python assets/utils/calculate_timecodes_easyread.py --json <path_to_json_file> --audio_folder <path_to_audio_folder> [--output <output_file_path>] [--continue_from] in the terminal
for example: python3 assets/utils/calculate_timecodes_easyread.py --json ../../translations_es.json --audio_folder ../.. --output my_timecodes.json
...
def main():
    ...
    parser.add_argument("--output", default="timecode_output.json", help="Path for the output JSON file. Default: timecode_output.json")
    ...
    valid_key_pattern = re.compile(r"^easyread-text-\d+-\d+$")
